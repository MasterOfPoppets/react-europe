...
var ServerTag = function () {
  ...
  ServerTag.prototype.toReactElement = function toReactElement() {
    var _attributes,
        _this2 = this;

    var attributes = (_attributes = {}, _attributes[SC_ATTR] = this.names.join(' '), _attributes[LOCAL_ATTR] = this.isLocal.toString(), _attributes);
    var css = Object.keys(this.components).map(function (key) {
      return _this2.components[key].css;
    }).join('');

    return React.createElement('style', _extends({ key: this.names.join(''), type: 'text/css' }, attributes, { dangerouslySetInnerHTML: { __html: css } }));
  };
